...
from ..config.exceptions import ProcessingError, FileProcessingError, ValidationError
...
class LabelProcessor(BaseProcessor):
    ...
    def create_empty_labels(self, images_dir: str, 
                           labels_dir: str = None,
        ...
        try:
            ...
            # 获取图像文件
            image_files = get_file_list(images_path, self.image_extensions, recursive=False)
            ...
            for creation_result in creation_results:
                if creation_result:
                    if creation_result["success"] and creation_result["action"] == "created":
    ...
    def flip_labels(self, labels_dir: str, 
    ...
    def filter_labels_by_class(self, labels_dir: str,
            ...
            for filter_result in filter_results:
                if filter_result:
                    if filter_result["success"]:
                        ...
                        result["statistics"]["annotations_removed"] += filter_result["annotations_removed"]
                        result["statistics"]["annotations_kept"] += filter_result["annotations_kept"]
                    else:
    ...
    def remove_empty_labels_and_images(self, dataset_dir: str,
                                      images_subdir: str = 'images',
                                      labels_subdir: str = 'labels') -> Dict[str, Any]:
        """删除空标签文件及其对应的图像
                ...
                if process_result:
                    if process_result["success"]:
                        if process_result["action"] == "removed":
                            ...
                            result["statistics"]["removed_images"] += process_result["removed_images_count"]
                    else:
    ...
    def remove_labels_with_only_class(self, dataset_dir: str,
                                     target_class: int,
                                     images_subdir: str = 'images',
                                     labels_subdir: str = 'labels') -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"开始删除只包含类别{target_class}的标签及图像: {dataset_path}")
    ...
    def convert_label_format(self, input_dir: str, output_dir: str,
